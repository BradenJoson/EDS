...
from models.Decoder import BertDecoder
...
def build_model(cfgs: TotalConfigs):
    ...
    model = HierarchicalModel(entity_level=entity_level_encoder,
                                ...
                                beam_size=beam_size, cfgs=cfgs, 
                                pad_idx=pad_idx, temperature=temperature,
                                eos_idx=eos_idx,
                                sos_idx=sos_idx,
                                unk_idx=unk_idx,
                                )
